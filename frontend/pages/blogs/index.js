...
const Blogs = ({ blogs, categories, tags, blogsLimit, blogSkip, totalBlogs, router }) => {
    ...
    const head = () => (
        <Head>
            ...
            <meta name="description"
                content="Programming blogs and tutorials on react node next vue php larvel  and web devellopment" />
